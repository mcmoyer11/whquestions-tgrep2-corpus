---
title: "Graphs for Experiment 2a, Root Questions NoContext Corpus Study"
author: Morgan Moyer
date: May 18, 2021
...
# ggsave("../graphs/ex2a_denisty_mean_ratings.pdf",width=6,height=3)
```
...
ggplot(agr, aes(x=paraphrase, y=mean_rating,fill=paraphrase, color=paraphrase)) + 
  ...
  scale_fill_manual(values=cbPalette) +
  scale_color_manual(values=cbPalette)
ggsave("../graphs/2a_violin.pdf",width=6,height=4)
```
...
ggplot(data = agr, aes(x = sd, fill=paraphrase, color=paraphrase)) +
  ...
  scale_fill_manual(values=cbPalette) +
  scale_color_manual(values=cbPalette)
# ggsave("../graphs/ex2a_denisty_context_sd.pdf",width=6,height=3)
```
